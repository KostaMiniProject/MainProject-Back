...
operation::comments-controller-test/add-comment[snippets='path-parameters,request-headers,http-request,http-response']

=== 댓글 수정

operation::comments-controller-test/update-comment[snippets='request-headers,path-parameters,http-request,http-response']

=== 댓글 조회

operation::comments-controller-test/find-comments[snippets='path-parameters,http-request,http-response']
...
operation::dibs-controller-test/get-user-dibs[snippets='path-parameters,http-request,http-response']
