...
operation::bid-controller-test/create-bid[snippets='request-headers,http-request,http-response']
...
operation::items-controller-test/search-items[snippets='curl-request,request-headers,http-request,http-response,response-fields']
...
operation::community-posts-controller-test/search[snippets='http-request,http-response,response-fields']
