...
public class ExchangeHistoriesResponseDto {
    ...
    private String myAdress; // 나의 주소
    private String myProfileImage; // 나의 프로필 이미지
    private List<Item> myItem; // 내가 건내준 물건의 리스트 (물건 이름, 물건 상세내용, 물건 대표이미지)
    private String otherUserName; // 상대방 닉네임
    private String otherUserAdress; // 상대방 사용자의 주소
    private String otherUserProfileImage; // 상대방 유저의 프로필 이미지
    private List<Item> otherUseritem; // 상대방이 건내준 물건의 리스트 (물건 이름, 물건 상세내용, 물건 대표이미지)
}
