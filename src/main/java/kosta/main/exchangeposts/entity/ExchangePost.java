...
public class ExchangePost extends Auditable {
    ...
    public void updateWithBuilder(User user, Item item, ExchangePostDTO dto) {
        ...
        this.preferItems = dto.getPreferItems().isPresent() ? dto.getPreferItems().get() : this.preferItems;
        this.address = dto.getAddress().isPresent() ? dto.getAddress().get() : this.address;
