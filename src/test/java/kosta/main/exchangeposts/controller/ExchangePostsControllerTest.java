        ...
        this.mockMvc.perform(get(BASIC_URL)
                ...
                .andDo(restDocs.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.[].createdAt").type(JsonFieldType.STRING).description(DESC_CREATED_AT),
        ...
        result.andDo(print())
                ...
                .andDo(restDocs.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content").type(JsonFieldType.STRING).description("물물교환 게시글 내용"),
                                fieldWithPath("exchangePostStatus").type(JsonFieldType.NULL).description("물물교환 게시글 내용"),
