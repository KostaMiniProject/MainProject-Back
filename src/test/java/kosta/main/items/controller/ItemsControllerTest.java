...
class ItemsControllerTest extends ControllerTest {
    ...
    void getItems() throws Exception {
        ...
        PageResponseDto<List<ItemPageDTO>> tPageResponseDto = new PageResponseDto<>(list, PageInfo.of(itemPageDTOs));

        // when
        given(itemsService.getItems(Mockito.any(User.class), Mockito.any(Pageable.class))).willReturn(tPageResponseDto);
        ...
        perform
                ...
                .andDo(restDocs.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.[].isBiding").type(JsonFieldType.STRING).description("물건의 입찰여부(NOT_BIDING, BIDING)"),
                                fieldWithPath("data.[].images").type(JsonFieldType.ARRAY).description("물건의 가장 첫번째 이미지"),
                                fieldWithPath("data.[].cratedAt").type(JsonFieldType.STRING).description("물건 생성 시각"),
        ...
        result
                ...
                .andDo(restDocs.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("createAt").type(JsonFieldType.STRING).description("물건 생성 시각"),
